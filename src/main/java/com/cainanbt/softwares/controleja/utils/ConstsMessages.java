...
public class ConstsMessages {
    public static final String FAILURE_TO_FIND_USER = "Falha ao encontrar Usuario";
    ...
    public static final String CREDIT_CARD_NOT_FOUND = "Cartão de crédito não encontrado.";
